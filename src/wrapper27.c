...
py_tall_render(PyObject *self, PyObject *args)
{
  ...
  tall_render(data->ob_bytes, num_colors);
...
py_tall_handle_gravity(PyObject *self, PyObject *args)
{
  ...
  int iterations = tall_handle_gravity(data->ob_bytes, num_colors);
...
py_tall_resolve(PyObject *self, PyObject *args)
{
  ...
  int chain;
  int score = tall_resolve(data->ob_bytes, num_colors, tsu_rules, &chain);
...
py_tall_encode(PyObject *self, PyObject *args)
{
  ...
  char *encoded = tall_encode(data->ob_bytes, num_colors);
...
py_tall_valid_moves(PyObject *self, PyObject *args)
{
  ...
  bitset_t valid = tall_valid_moves(data->ob_bytes, num_colors, tsu_rules);
